...
%>
<tr>
<td width="110"><%=rs.getString(4)%> </td>
<td width="423"><%=rs.getString(6)%></td>
<td width="99"> <span class="style6"><a href="tmatview2.jsp?a1=<%=rs.getString(1)%>&a2=<%=ar[1]%>"><%= rs.getString(5)%></a></span></td>

<td width="423"><%=rs.getString(9)%> </span></td>
<td width="71"><span class="style5"><a href="tmat3.jsp?a1=<%=rs.getString(1)%>">Delete</a> </span></td>
</tr>
<%
}
con.close();
