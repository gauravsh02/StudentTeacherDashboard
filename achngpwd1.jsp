...
<%
try{
 String uid = request.getParameter("s1");
 String pwd = request.getParameter("p1");
 st.executeUpdate("update login set pwd='"+pwd+"' where uid='"+uid+"'");
 out.print("<font color=green size=2>Password Changed Successfully.</font>");
 con.close();
 }catch(Exception e){ }
%>
