...
<div class="rightside_head">Welcome <%= (String) session.getAttribute("name") %> to Sign Out.</div>  <br>
<br>


 <font size="3">   Please Confirm to <a href="index1.jsp" class="style4">Sign out</a></font> 
